            ...
            <div className="flex flex-col justify-center items-center flex-1 min-h-36">
                ...
                <div className="flex justify-center items-stretch gap-4 px-5 py-10 w-full max-w-6xl flex-col sm:flex-row">
                    ...
                    >
                        ...
                        <CardBody className="overflow-visible">
                            <p className="w-full text-wrap">
                                Retrieval Augmented Generation (RAG) is a tool
                                that allow you to retrieve and generate text
                                based on your sources powered by AI.
                            </p>
                        </CardBody>
                        <Spacer />
                    </Card>
                    ...
                    >
                        ...
                        <CardBody className="overflow-visible">
                            <p className="w-full text-wrap">
                                Tokenizer is a playground where you can generate
                                alternate end of sentence made by AI.
                            </p>
                        </CardBody>
                        <Spacer />
                    </Card>
                    ...
                    >
                        ...
                        <CardBody className="overflow-visible">
                            <p className="w-full text-wrap">
                                Model Compare is a tool that allow you to
                                compare the output of Large Language Models
                                (LLM) like GPT, LlaMA 3...
                            </p>
                        </CardBody>
                        <Spacer />
                    </Card>
